...
function main(servicesPath, additionalServices) {
  ...
  program
    ...
    .action(function(services){
      ...
      if (!configInfo) {
        throw new Error('Could not find configuration, see `litecore-tealcoin-node create --help`');
      }
      var opts = {
      ...
      console.log();
      console.log('    $ litecore-tealcoin-node add wallet-service');
      console.log('    $ litecore-tealcoin-node add insight-api');
      console.log();
    });
  ...
  program
    ...
    .action(function(services){
      ...
      console.log('  Examples:');
      console.log();
      console.log('    $ litecore-tealcoin-node remove wallet-service');
      console.log('    $ litecore-tealcoin-node remove insight-api');
      console.log();
    });
