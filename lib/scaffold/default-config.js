...
/**
 * Will return the path and default litecore-tealcoin-node configuration. It will search for the
 * configuration file in the "~/.tealcoin" directory, and if it doesn't exist, it will create one
...
function getDefaultConfig(options) {
  ...
  var defaultPath = path.resolve(process.env.HOME, './.tealcoin');
  var defaultConfigFile = path.resolve(defaultPath, './litecore-tealcoin-node.json');
