...
/**
 * Will return the path and litecore-tealcoin-node configuration
...
function findConfig(cwd) {
  ...
  while (!fs.existsSync(path.resolve(directory, 'litecore-tealcoin-node.json'))) {
  ...
  return {
    path: directory,
    config: require(path.resolve(directory, 'litecore-tealcoin-node.json'))
  };
}
